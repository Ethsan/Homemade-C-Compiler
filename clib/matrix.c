...
void mat_copy_row(int r_in, int c_in, int r_out, int c_out, int r_start, int r_end, int c_off, float *out, float *in) { // copy row from in to out
	int i, j;
...
void mat_copy_col(int r_in, int c_in, int r_out, int c_out, int c_start, int c_end, int r_off, float *out, float *in) { // copy col from in to out
	int i, j;
	for (i = 0; i < r_in; ++i) {
