...
void mat_copy_row(int r_in, int c_in, int c_out, int r_start, int r_end, int r_off, float *out, float *in);

void mat_copy_col(int r_in, int c_in, int c_out, int c_start, int c_end, int c_off, float *out, float *in);
